...
def afk(bot: Bot, update: Update):
    ...
    update.effective_message.reply_text("My Boss {} Is Currently Busy ".format(update.effective_user.first_name))
...
def no_longer_afk(bot: Bot, update: Update):
    ...
    if res:
        update.effective_message.reply_text("{} Is Now Here".format(update.effective_user.first_name))
