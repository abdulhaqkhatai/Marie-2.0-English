...
It took lots of work for [my creator](t.me/Souk26) to get me to where I am now, and every donation helps \
...
def start(bot: Bot, update: Update, args: List[str]):
    if update.effective_chat.type == "private":
        ...
        update.effective_message.reply_text("I'm Awake Sexy😘😘")
